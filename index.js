...
app.post('/api/chat', async (req, res) => {
  ...
  try {
    ...
    else if (model==='gpt')    await runNvidia(messages, buildStringSystem(freestyle,system), res, 'z-ai/glm-5.2', false);
